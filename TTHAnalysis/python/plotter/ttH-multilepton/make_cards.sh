...
OPTIONS="${OPTIONS} --od $OUTNAME ";

SYSTS="ttH-multilepton/systsEnv.txt"
#SYSTS="ttH-multilepton/systsATLASlike.txt"
BLoose=" -E ^BLoose "
BTight=" -E ^BTight "
...
#FUNCTION_2L="max(abs(LepGood1_eta),abs(LepGood2_eta)):max(abs(LepGood1_eta),abs(LepGood2_eta)) 10,0.,2.5,1,0.,2.5"
#FUNCTION_2L="LepGood1_eta:LepGood2_eta 1,-2.5,2.5,1,-2.5,2.5"

BINFUNCTION_2L="8:OurBin2l"
BINFUNCTION_3L="5:OurBin3lMEM"
#BINFUNCTION_2L="1:testbin"
#BINFUNCTION_2L="10:MaxEta2Dto1D"
...
if [[ "$1" == "all" || "$1" == "2lss" || "$1" == "2lss_3j" ]]; then
    ...
    OPT_2L="${OPT_2L} --asimov "
    for X in mm ee em; do 
        echo "2lss_${X}";

	FLAV=" -E ^${X} "
	if [[ "${X}" == "ee" ]]; then
	    echo python makeShapeCards.py ${DOFILE} --2d-binning-function ${BINFUNCTION_2L} ttH-multilepton/mca-2lss-${MCASUFFIX}${SPLITDECAYS}.txt ttH-multilepton/2lss_tight.txt ${FUNCTION_2L} $SYSTS $OPT_2L -o 2lss_${X}_pos${CATPOSTFIX} $POS $FLAV;
	    ...
	    echo python makeShapeCards.py ${DOFILE} --2d-binning-function ${BINFUNCTION_2L} ttH-multilepton/mca-2lss-${MCASUFFIX}${SPLITDECAYS}.txt ttH-multilepton/2lss_tight.txt ${FUNCTION_2L} $SYSTS $OPT_2L -o 2lss_${X}_neg${CATPOSTFIX} $NEG $FLAV;
	    ...
	    #python makeShapeCards.py ${DOFILE} --2d-binning-function ${BINFUNCTION_2L} ttH-multilepton/mca-2lss-${MCASUFFIX}${SPLITDECAYS}.txt ttH-multilepton/2lss_tight.txt ${FUNCTION_2L} $SYSTS $OPT_2L -o 2lss_${X}_bl_pos${CATPOSTFIX} $POS $BLoose $FLAV;
	    echo python makeShapeCards.py ${DOFILE} --2d-binning-function ${BINFUNCTION_2L} ttH-multilepton/mca-2lss-${MCASUFFIX}${SPLITDECAYS}.txt ttH-multilepton/2lss_tight.txt ${FUNCTION_2L} $SYSTS $OPT_2L -o 2lss_${X}_bl_neg${CATPOSTFIX} $NEG $BLoose $FLAV;
	    ...
	    echo python makeShapeCards.py ${DOFILE} --2d-binning-function ${BINFUNCTION_2L} ttH-multilepton/mca-2lss-${MCASUFFIX}${SPLITDECAYS}.txt ttH-multilepton/2lss_tight.txt ${FUNCTION_2L} $SYSTS $OPT_2L -o 2lss_${X}_bt_pos${CATPOSTFIX} $POS $BTight $FLAV;
	    ...
	    echo python makeShapeCards.py ${DOFILE} --2d-binning-function ${BINFUNCTION_2L} ttH-multilepton/mca-2lss-${MCASUFFIX}${SPLITDECAYS}.txt ttH-multilepton/2lss_tight.txt ${FUNCTION_2L} $SYSTS $OPT_2L -o 2lss_${X}_bt_neg${CATPOSTFIX} $NEG $BTight $FLAV;
...
if [[ "$1" == "2lss_nocat" ]]; then
    ...
    for X in mm ee em; do 
        echo "2lss_${X}";
	FLAV=" -E ^${X} "
	echo python makeShapeCards.py ${DOFILE} --2d-binning-function ${BINFUNCTION_2L} ttH-multilepton/mca-2lss-${MCASUFFIX}${SPLITDECAYS}.txt ttH-multilepton/2lss_tight.txt ${FUNCTION_2L} $SYSTS $OPT_2L -o 2lss_${X}${CATPOSTFIX}  $FLAV 
        #python makeShapeCards.py ${DOFILE} --2d-binning-function ${BINFUNCTION_2L} ttH-multilepton/mca-2lss-${MCASUFFIX}${SPLITDECAYS}.txt ttH-multilepton/2lss_tight.txt ${FUNCTION_2L} $SYSTS $OPT_2L -o 2lss_${X}${CATPOSTFIX}  $FLAV;
...
if [[ "$1" == "all" || "$1" == "3l" ]]; then
    ...
    echo python makeShapeCards.py ${DOFILE} --2d-binning-function ${BINFUNCTION_3L} ttH-multilepton/mca-3l-${MCASUFFIX}${SPLITDECAYS}.txt ttH-multilepton/3l_tight.txt ${FUNCTION_3L} $SYSTS $OPT_3L -o 3l_bl_neg${CATPOSTFIX} $NEG $BLoose;
    echo python makeShapeCards.py ${DOFILE} --2d-binning-function ${BINFUNCTION_3L} ttH-multilepton/mca-3l-${MCASUFFIX}${SPLITDECAYS}.txt ttH-multilepton/3l_tight.txt ${FUNCTION_3L} $SYSTS $OPT_3L -o 3l_bt_pos${CATPOSTFIX} $POS $BTight;
    echo python makeShapeCards.py ${DOFILE} --2d-binning-function ${BINFUNCTION_3L} ttH-multilepton/mca-3l-${MCASUFFIX}${SPLITDECAYS}.txt ttH-multilepton/3l_tight.txt ${FUNCTION_3L} $SYSTS $OPT_3L -o 3l_bt_neg${CATPOSTFIX} $NEG $BTight;
