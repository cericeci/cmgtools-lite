...
if [[ "$1" == "all" || "$1" == "3l" ]]; then
    ...
    echo "3l";
    echo python makeShapeCards.py ${DOFILE} --2d-binning-function ${BINFUNCTION_3L} ttH-multilepton/mca-3l-${MCASUFFIX}${SPLITDECAYS}.txt ttH-multilepton/3l_tight.txt ${FUNCTION_3L} $SYSTS $OPT_3L -o 3l_bl_pos${CATPOSTFIX} $POS $BLoose;
...
if [[ "$1" == "all" || "$1" == "4l" ]]; then
    ...
    echo "4l";
    echo python makeShapeCards.py ${DOFILE} ttH-multilepton/mca-4l-${MCASUFFIX}${SPLITDECAYS}.txt ttH-multilepton/4l_tight.txt ${ONEBIN_4L} $SYSTS $OPT_4L -o 4l${CATPOSTFIX};
