...
class coeffs(object):
    ...
    def __init__(self, histoc,histoc2, isZ, tag):
        self.histoc = histoc
        self.histoc2 = histoc2
        self.isZ = isZ
        self.tag = tag
        self.quadF = ROOT.TF1("quad" + tag, "[0]+[1]*x+[2]*x*x", -1.2,1.2)
        self.f0 = ROOT.TF1("f0" + tag, "2*(1-x*x)*[0]", -1.2,1.2)
        self.fL = ROOT.TF1("fL" + tag, "(1-x)*(1-x)*[0]", -1.2,1.2)
        self.fR = ROOT.TF1("fR" + tag, "(1+x)*(1+x)*[0]", -1.2,1.2)
    def load(self):
    ...
    def doControl(self):
        ...
        self.histoc.GetXaxis().SetTitle("q_{l}*cos(#theta_{3})")
        ...
        self.histoc.GetXaxis().SetTitleOffset(1.2)
        ...
        self.histoc.SetMaximum(80000)
        self.histoc.SetMinimum(0)
        self.histoc.Draw("hist")
