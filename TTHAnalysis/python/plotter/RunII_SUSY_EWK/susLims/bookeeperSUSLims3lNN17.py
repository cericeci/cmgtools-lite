...
for m in massSplits:
  ...
  oDir[var.replace("split",str(m))] = "/nfs/fanae/user/carlosec/Combine_SLC7/CMSSW_8_1_0/src/EWKINO_CARDS_LEGACY/cards_3lA17_"+str(m)
